...
import LoaderDirective from './directives/loader_directive'
import SyncLoaderDirective from './directives/sync_loader_directive'
import GlobalController from './controllers/global_controller'

export default angular.module('sosaicsimg',[angularAnimate,ui_bootstrap,angularMoment,ngTouch,'ui.uploader'])
  ...
  .directive('syncloader',SyncLoaderDirective)
